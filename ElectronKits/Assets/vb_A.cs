...
public class vb_A : MonoBehaviour, IVirtualButtonEventHandler
{
	private GameObject vbutton_A;
	...
	void Start () {
		...
		vbutton_A = GameObject.Find("vb_A");
		vbutton_A.GetComponent<VirtualButtonBehaviour>().RegisterEventHandler(this);
	...
	public void OnButtonPressed(VirtualButtonAbstractBehaviour vb)
	{
		...
		{
			showAnswer.text = "<b><color=lime>Correct! Well Done!</color></b>"; //Answer is A
			showAnswer1.text = "<b><color=lime>Correct! Well Done!</color></b>"; //Answer is A
			showAnswer22k.text = "<b><color=lime>Correct!\nThis is a 22 K Ω resistor!</color></b>"; //Answer is A

			explain_textbox22k.GetComponent<Renderer>().enabled = false;

			show_option.getCorrectAns22k = true;
		...
		{
			showAnswer.text = "<b><color=red><size=200>A</size>   is  INCORRECT!</color></b>"; //Answer is B
			showAnswer1.text = "<b><color=red><size=200>A</size>   is  INCORRECT!</color></b>"; //Answer is B
			showAnswer1_5k.text = "<b><color=red><size=200>A</size>  is  INCORRECT!\n Try Again!</color></b>";  //Answer is B
		...
		{
			showAnswer.text = "<b><color=red><size=200>A</size>   is  INCORRECT!</color></b>"; //Answer is D
			showAnswer1.text = "<b><color=red><size=200>A</size>   is  INCORRECT!</color></b>"; //Answer is D
			showAnswer1k.text = "<b><color=red><size=200>A</size>  is  INCORRECT!\n Try Again!</color></b>";  //Answer is D
