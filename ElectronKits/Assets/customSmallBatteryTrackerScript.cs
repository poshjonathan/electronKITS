...
public class customSmallBatteryTrackerScript : MonoBehaviour,
													ITrackableEventHandler
	{
		//Added this line to create text variable for text display
		public Text scanToCont;
		public static bool smallBattery;
		...
		private void OnTrackingFound()
		{
			...
			smallBattery = true;
			Debug.Log("Trackable " + mTrackableBehaviour.TrackableName + "" + smallBattery);
