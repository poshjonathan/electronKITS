...
public class customSmallResistorTrackerScript : MonoBehaviour,
													ITrackableEventHandler
	{
		//Added this line to create text variable for text display
		public Text scanToCont;
		public static bool smallResistor;
		...
		private void OnTrackingFound()
		{
			...
			smallResistor = true;
			Debug.Log("Trackable " + mTrackableBehaviour.TrackableName + "" + smallResistor);
