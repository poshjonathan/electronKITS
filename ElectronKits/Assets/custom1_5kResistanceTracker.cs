...
namespace Vuforia
{
	...
	public class custom1_5kResistanceTracker : MonoBehaviour,
												ITrackableEventHandler
	{
		//Added this line to create text variable for text display
		public Text scanToCont;
		public static bool resistor_1_5k;
		...
		private void OnTrackingFound()
		{
			...
			resistor_1_5k = true;
			Debug.Log("Trackable " + mTrackableBehaviour.TrackableName + "" + resistor_1_5k);
